...
<body>
    ...
    <div>
        <section class=" col-md-6" style="float: right;padding:20px">
            <div class="card text-white mb-3" style="max-width: 18rem; background-color: #18a4bc;">
                <div class="card-header" style="font-weight: bold; text-align:Right"> Faculty ID</div>
                <div class="card-body">
                    <p class="card-text" style="color:white;text-align:right">
                        <?php
                        echo  date( $_SESSION['T_ID']);
                        ?>
                    </p>
                </div>
        </section>
    ...
    <div class="col-md-6">
    <a style="color: White;" href="faculty.php"><button class="btn btn-info ">Back</button></a>
